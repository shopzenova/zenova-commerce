...
const CSV_FILE = './diffusori-oli-nuovi-NEW.csv';
const CATEGORIA = 'diffusori-oli';
const NOME_CATEGORIA = 'Diffusori Oli';
const TAGS = ['diffusore', 'reed diffuser', 'fragranza', 'aromaterapia', 'natural wellness', 'oli essenziali'];
const DESCRIZIONE_DEFAULT = 'Reed Diffuser per aromaterapia di alta qualità con bastoncini in rattan indonesiano.';
