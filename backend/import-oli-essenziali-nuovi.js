...
const CSV_FILE = './oli-essenziali-nuovi-NEW.csv';                    // Nome del file CSV
const CATEGORIA = 'oli-essenziali';                     // es: diffusori-oli, oli-essenziali, pietre-preziose
const NOME_CATEGORIA = 'Oli Essenziali Wholesale';                // es: Diffusori Oli, Oli Essenziali, Pietre Preziose
const TAGS = ['olio essenziale', 'aromaterapia', 'wholesale', 'confezione 10 pezzi', 'natural wellness'];                  // Tags per i prodotti
const DESCRIZIONE_DEFAULT = 'Confezione da 10 pezzi di oli essenziali puri 10ml per aromaterapia professionale.';   // Usata se manca nel CSV
