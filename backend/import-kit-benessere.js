...
const CSV_FILE = './kit-benessere-NEW.csv';                    // Nome del file CSV
const CATEGORIA = 'kit-benessere-cofanetti-regalo';         // es: diffusori-oli, oli-essenziali, pietre-preziose
const NOME_CATEGORIA = 'Kit Benessere e Cofanetti Regalo';  // es: Diffusori Oli, Oli Essenziali, Pietre Preziose
const TAGS = ['regalo', 'kit benessere', 'cofanetto', 'gift box', 'candela', 'wellness'];  // Tags per i prodotti
const DESCRIZIONE_DEFAULT = 'Cofanetto regalo benessere con candela e prodotti per il bagno.';   // Usata se manca nel CSV
