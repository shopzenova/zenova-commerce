...
const BACKUP_FILE = `./products.backup-update-rdeo-images-${Date.now()}.json`;

console.log('🖼️  Aggiornamento percorsi immagini RDEO...\n');
...
// Aggiorna i prodotti RDEO
let updatedCount = 0;
products.forEach(product => {
    if (product.sku && product.sku.startsWith('RDEO')) {
